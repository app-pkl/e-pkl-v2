...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-info">
            ...
            <?php } ?>
            <form class="form-horizontal" action="<?= base_url('mahasiswa/home/createPengajuan'); ?>" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal" class="form-control" id="tanggal" required placeholder="Tanggal PKL">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Tahun Ajaran</label>
                        <div class="col-sm-10">
                            <input type="number" name="tahun" class="form-control" id="tahun" required placeholder="Tahun Ajaran">
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
